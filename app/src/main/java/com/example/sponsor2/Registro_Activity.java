    ...
    private void registrarUsuario(){
        ...
        if(verificacion) {
            ...
            if(!TextUtils.isEmpty(email) || !TextUtils.isEmpty(password) || !TextUtils.isEmpty(nombre) || !TextUtils.isEmpty(apellido) || !TextUtils.isEmpty(numero) || !TextUtils.isEmpty(fecha) ){
                ...
                UsuariosEstudiantes usuario = new UsuariosEstudiantes(email,password,nombre,apellido,numero,fecha,codigoRegistro,"Null", "NULL");
                BDUsuarios.child("Informacion").child("Estudiantes").child(id).setValue(usuario);
